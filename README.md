...
<img width="1919" height="1089" alt="Screenshot 2025-10-22 145910" src="https://github.com/user-attachments/assets/a2fd5a1a-2d8e-4677-a7be-5ed5a9987563" />

# RESULT: 
Thus, to implement a fully private and transparent voting system using Zero-Knowledge Proofs (ZKPs). This ensures that votes are counted fairly without revealing who voted for whom has been done successfully.
